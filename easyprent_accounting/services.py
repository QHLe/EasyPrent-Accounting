...
from .settings import get_application_settings, get_gnucash_connection_settings
...
def settlement_run_ods(
    ...
    return settlement_ods_for_period(
        config, connection, run["property_id"], lease_id, run["period_start"], run["period_end"],
